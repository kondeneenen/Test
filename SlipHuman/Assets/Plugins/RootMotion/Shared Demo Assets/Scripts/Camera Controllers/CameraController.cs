    ...
    public class CameraController : MonoBehaviour
    {
        ...
        public void UpdateInput()
        {
            ...
            if (rotate)
            {
                if (_gamepad != null)
                {
                    x += _gamepad.rightStick.ReadValue().x;
                    y = ClampAngle(y - _gamepad.rightStick.ReadValue().y, yMinLimit, yMaxLimit);
                }
                ...
                if (_mouse != null)
                {
                    ...
                    {
                        //x += _mouse.delta.value.x * 0.03f;
                        //y = ClampAngle(y - _mouse.delta.value.y * 0.03f, yMinLimit, yMaxLimit);
                    }
                }
            }
        ...
        private float zoomAdd
        {
            get
            {
                float scrollAxis = _mouse != null ? _mouse.scroll.value.y : 0f;
